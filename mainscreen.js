...
class MainScreen {
    ...
    showLoadingState(button) {
        if (button) {
            ...
            button.innerHTML = '<div class="flex items-center justify-center space-x-2"><div class="animate-spin rounded-full h-5 w-5 border-b-2 border-gray-900"></div><span>Performing Detailed Analysis...</span></div>';
        }
    }
